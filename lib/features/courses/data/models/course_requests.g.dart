...
_DeleteCourseRequest _$DeleteCourseRequestFromJson(Map<String, dynamic> json) =>
    _DeleteCourseRequest(id: json['id'] as String);

Map<String, dynamic> _$DeleteCourseRequestToJson(
  _DeleteCourseRequest instance,
